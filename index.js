...
function addGamesToPage(games) {     
    ...
    for ( var i = 0; i < games.length; i++ ) {
        ...
        var str = `<img src="${games[i].img}" class="game-img" /> ${games[i].name}: ${games[i].description}`;

        // add template literal to the inner HTML of the game card
        div.innerHTML = str;
...
function showAllGames() {
    ...
    console.log( "all: " + GAMES_JSON.length ); 
}
...
const displayStr = `A total of ${unfundedGamesCount} ${unfundedGamesCount == 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;    
